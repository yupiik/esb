...
public class ObservabilityCamelContext {
    ...
    public void activate(ComponentContext context) throws Exception {
        ...
        profile.setPoolSize(Integer.valueOf(camelContext.getPropertiesComponent().resolveProperty("esbcloud.observability.context.thread.min").orElseThrow()));
        profile.setMaxPoolSize(Integer.valueOf(camelContext.getPropertiesComponent().resolveProperty("esbcloud.observability.context.thread.max").orElseThrow()));
        profile.setMaxQueueSize(Integer.valueOf(camelContext.getPropertiesComponent().resolveProperty("esbcloud.observability.context.queue.max").orElseThrow()));
